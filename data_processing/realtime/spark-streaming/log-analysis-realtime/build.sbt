...
libraryDependencies += "org.apache.spark" % "spark-streaming-flume_2.11" % "2.4.8"
libraryDependencies += "org.apache.flume" % "flume-ng-sdk" % "1.11.0"
libraryDependencies += "org.apache.flume" % "flume-ng-core" % "1.11.0"
libraryDependencies += "org.apache.flume" % "flume-ng-configuration" % "1.11.0"
libraryDependencies += "org.apache.avro" % "avro-ipc-netty" % "1.11.0"
